/*
    ...
    Woodsman © 2023. Design & Coded by Mountain-Themes.
...
function mt_google_map() {
 ...
 var contentString = '<div class="contact-box left" data-sr="wait 0.5s, then enter left and move 40px over 1s">'+
      '<h3 data-sr="wait 0.5s, then enter left and move 140px over 1s">CONTACT INFORMATION.</h3>'+
         '<ul>'+
